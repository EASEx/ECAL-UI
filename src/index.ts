...
//!!!TODO Automated Reporting of all errors to backend!
import unhandled from "electron-unhandled";
unhandled();

const { autoUpdater } = require("electron");

const server = "https://hazel-deployment.vercel.app/";
...
const createWindow = (): void => {
  ...
  agentView.setBounds({ x: 0, y: 0, width: 1200, height: 600 });
  // jupyterView.setBounds({ x: 600, y: 0, width: 600, height: 600 });
  agentView.webContents.loadURL(MAIN_WINDOW_WEBPACK_ENTRY);
  jupyterView.webContents.loadURL(
    "https://colab.research.google.com/drive/1e_sM8wmZ5gw0iAGR09dSP_TPrDJJNLWu?usp=sharing"
  );
